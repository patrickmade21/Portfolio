...
export default async function Project({ params }: { params: Promise<{ slug: string }> }) {
    ...
    return (
        <section>
            ...
            />
            {post.metadata.image && !post.metadata.image.startsWith('http') && (
                <div className="relative w-full h-64 mb-10 overflow-hidden rounded-xl bg-neutral-100 dark:bg-neutral-800">
                    <img
